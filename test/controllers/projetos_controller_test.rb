...
class ProjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post projetos_url, params: { projeto: { bug: @projeto.bug, projeto: @projeto.projeto } }
    end
  ...
  test "should update projeto" do
    patch projeto_url(@projeto), params: { projeto: { bug: @projeto.bug, projeto: @projeto.projeto } }
